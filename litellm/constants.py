...
# Based on Google Gemini 2.5 thinking docs:
# - reasoning_effort=minimal/low => ~1,024 thinking tokens
# - reasoning_effort=medium      => ~8,192 thinking tokens
# - reasoning_effort=high        => ~24,576 thinking tokens (max recommended for Flash)
...
DEFAULT_REASONING_EFFORT_MINIMAL_THINKING_BUDGET = int(
    os.getenv("DEFAULT_REASONING_EFFORT_MINIMAL_THINKING_BUDGET", 1024)
)
...
DEFAULT_REASONING_EFFORT_MEDIUM_THINKING_BUDGET = int(
    os.getenv("DEFAULT_REASONING_EFFORT_MEDIUM_THINKING_BUDGET", 8192)
)
DEFAULT_REASONING_EFFORT_HIGH_THINKING_BUDGET = int(
    os.getenv("DEFAULT_REASONING_EFFORT_HIGH_THINKING_BUDGET", 24576)
)

# Gemini 2.5 Pro-specific high reasoning budget (max supported thinking budget)
DEFAULT_REASONING_EFFORT_HIGH_THINKING_BUDGET_GEMINI_2_5_PRO = int(
    os.getenv(
